<?php
// Se oculta el input de descripcion larga y tags cuando el formulario es llamado desde el popup de embed. Esto lo hacemos para evitar que el formulario se muy tedioso de completar. 
