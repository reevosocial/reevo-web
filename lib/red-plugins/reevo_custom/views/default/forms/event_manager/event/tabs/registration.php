...
echo elgg_view_field([
	...
	'#help' => elgg_echo('event_manager:edit:form:registration_ended:help'),
	'class' => 'mts',
]);
echo '<br />';
...
echo elgg_view_field([
	'#type' => 'text',
	'#label' => elgg_echo('event_manager:edit:form:addgroups'),
	'#help' => elgg_echo('event_manager:edit:form:addgroups:help2'),
	'#class' => $field_class,
	'name' => 'addgroups',
	'id' => 'addgroups',
	'value' => $event->addgroups,
	'placeholder' => elgg_echo('event_manager:edit:form:addgroups:help'),
]);
echo '</div></div>';
