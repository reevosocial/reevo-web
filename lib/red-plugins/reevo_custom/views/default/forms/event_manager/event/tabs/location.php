...
global $fbevent;
if (!empty($fbevent)) {
	$venue = $fbevent['place']['name'] . ' (' . $fbevent['place']['location']['city'] . ', ' . $fbevent['place']['location']['country'] .')';
	$location = $fbevent['place']['location']['street'] . ', ' . $fbevent['place']['location']['city'] . ', ' . $fbevent['place']['location']['country'];
} else {
