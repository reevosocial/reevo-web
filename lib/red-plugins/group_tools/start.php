...
function group_tools_init() {
	...
	elgg_register_plugin_hook_handler('cron', 'minute', '\ColdTrick\GroupTools\Membership::autoJoinGroupsCron');
	...
	elgg_extend_view('groups/edit', 'group_tools/forms/tools_options');
	...
	// tools_options views
	elgg_extend_view('resources/blog/add', 'group_tools/extends/blog/add', 450);
	...
	elgg_register_action('group_tools/tools_options', dirname(__FILE__) . '/actions/tools_options.php');
