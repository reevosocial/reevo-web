...
(function($) {
    ...
    CKEDITOR.dialog.add( 'footnotesDialog', function( editor ) {
        ...
        return {
            ...
            title: elgg.echo('ckeditor:footnotes'),
            minWidth: 400,
            minHeight: 200,
            footnotes_el: false,
                    ...
                    elements: [
                        {
                            ...
                            id: 'new_footnote',
                            'class': 'footnote_text',
                            label: elgg.echo('ckeditor:footnotes:new'),
                        ...
                        },
                        {
                            ...
                            id: 'footnote_id',
                            name: 'footnote_id',
                            label: elgg.echo('ckeditor:footnotes:none'),
                            ...
                            setup: function( element ) {
                                ...
                                if ($footnotes.length > 0) {
                                    if ($el.find('p').length == 0) {
                                        $el.append('<p style="margin-bottom: 10px;"><strong>O:</strong>'+elgg.echo('ckeditor:footnotes:choose')+'</p><ol class="footnotes_list"></ol>');
                                    } else {
                                        $el.find('ol').empty();
                                    }
