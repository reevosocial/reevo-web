...
echo elgg_view_input('text', [
	'label' => elgg_echo('contact:first_name'),
	'name' => 'first_name',
	'value' => elgg_get_sticky_value('contact', 'first_name')
]);

echo elgg_view_input('text', [
	'label' => elgg_echo('contact:last_name'),
	'name' => 'last_name',
	'value' => elgg_get_sticky_value('contact', 'last_name')
]);
...
echo elgg_view_input('select', [
	'label' => elgg_echo('contact:country'),
	'name' => 'country',
	// 'options' => array(
	// 	'', 'object', 'user', 'group', 'site', 'relationship', 'annotation',
	// ),
	'options_values' => $country_list,

]);

echo elgg_view_input('text', [
	'label' => elgg_echo('contact:city'),
	'name' => 'city',
	'value' => elgg_get_sticky_value('contact', 'city')
]);
