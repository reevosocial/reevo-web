...
// MODIFICACIONES: cambié el orden de los elementos. La fecha primero, luego la imagen destacada, luego todo el resto.
...
if (!empty($event_banner_url)) {
	$event_details .= "<div style='background-image: url({$event_banner_url})' class='event-manager-event-banner-bg-blur mbm elgg-border-plain event-manager-event-banner'>";
