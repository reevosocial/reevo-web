	...
	public function embed($raw, $auto = FALSE, $echo = TRUE)
	{
		...
		switch($this->service_name)
		{
			case "youtube":
				...
				$output = '<iframe id="ytplayer" type="text/html" width="525" height="332" '
			...
			case "google":
				...
				$output = "<embed style='width:525px; height:332px;' id='VideoPlayback' type='application/x-shockwave-flash'"
			...
			case "metacafe":
				...
				$output = "<embed src='http://www.metacafe.com/fplayer/".html::escape($code).".swf'"
					. "	width='525' height='332' wmode='transparent' pluginspage='http://get.adobe.com/flashplayer/'"
					. "	type='application/x-shockwave-flash'> "
					. "</embed>";
			break;
			
			case "dotsub":
				$output = "<iframe src='http://dotsub.com/media/".html::escape($code)."' frameborder='0' width='525' height='500'></iframe>";
			...
			case "vimeo":
				...
				$output = '<iframe src="http://player.vimeo.com/video/'.html::escape($code.$vimeo_auto).'" width="525" height="332" frameborder="0">'
					. '</iframe>';
			break;
		}
