...
ActiveRecord::Schema.define(:version => 20140228130325) do
  ...
  create_table "latest_issues_setups", :id => false, :force => true do |t|
  ...
  create_table "mentions", :force => true do |t|
    ...
    t.string   "mentioning_type", :limit => 30, :null => false
  ...
  create_table "overview_blocks", :force => true do |t|
    t.integer "project_id", :null => false
    t.string  "name",       :null => false
  end
  ...
  create_table "wiki_macros", :force => true do |t|
